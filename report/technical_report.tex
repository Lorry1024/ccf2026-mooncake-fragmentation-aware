...
\begin{titlepage}
  ...
  \begin{tabular}{|>{\sffamily\bfseries\centering\arraybackslash}p{3.2cm}|>{\raggedright\arraybackslash}p{9.3cm}|}
    ...
    GitLink仓库 & \url{https://gitlink.org.cn/liushenzhou/ccf2026-mooncake-fragmentation-aware} \\ \hline
...
\begin{itemize}
  ...
  \item GitLink比赛材料仓库：\href{https://gitlink.org.cn/liushenzhou/ccf2026-mooncake-fragmentation-aware}{liushenzhou/ccf2026-mooncake-fragmentation-aware}

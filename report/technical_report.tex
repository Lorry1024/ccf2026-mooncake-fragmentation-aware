...
\begin{table}[htbp]
  ...
  \begin{tabular}{|l|r|r|r|l|}
    \hline
    \tabhead segment & 总容量 & 总空闲 & 最大连续空闲 & 10MiB请求 \\ \hline
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{|B{3.1cm}|L{4.9cm}|Y|}
    \hline
    \tabhead 比较项 & 依赖fallback & 碎片感知排序 \\ \hline
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{|l|r|r|r|l|Y|}
    \hline
    \tabhead segment & 总空闲 & 最大连续空闲 & 请求大小 & \artifact{can\_fit} & 排序解释 \\ \hline
...
\begin{table}[h]
  ...
  \begin{tabular}{|l|r|r|}
    \hline
    \tabhead 指标 & \baseline{} & \strategy{} \\ \hline
